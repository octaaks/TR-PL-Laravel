  ...
  <tbody>
    @foreach($data_minuman as $minuman)
		<tr>
			...
			<td>{{$minuman->harga}}</td>
			<td width="20%">
			<a class="btn btn-primary  btn-sm" href="/editminuman/{{$minuman->id}}" role="button">Edit</a>
			<a class="btn btn-danger  btn-sm" href="/deleteminuman/{{$minuman->id}}" role="button">Delete</a>
		</tr>
		@endforeach
  </tbody>
</table>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-body">
            <form method="post" action="/addminuman">
            {{ csrf_field() }}
            <div class="">
